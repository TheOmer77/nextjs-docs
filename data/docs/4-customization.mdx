...
- `index.mdx` - Home page of this docs site, will be displayed when navigating to the default route (`/`).
- `_not-found.mdx` - The "404 not found" error page of the site, will be displayed when attempting to navigate to a URL of a page that doesn't exist. If not present, a default error page will be used.
