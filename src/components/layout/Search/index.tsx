...
justify-center gap-2 rounded-lg text-neutral-700 state-layer
...
dark:text-neutral-300 sm:w-64 sm:justify-start sm:bg-neutral-50 sm:px-4
dark:sm:bg-neutral-900 [&>svg]:text-lg [&>svg]:sm:text-base'
