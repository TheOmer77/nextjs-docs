...
>(({ children, ...props }, ref) => (
  <CommandRoot
    ref={ref}
    className='flex h-full w-full flex-col overflow-hidden rounded-lg bg-white text-neutral-800 dark:bg-neutral-900 dark:text-neutral-200'
    {...props}
  >
    <div
      ...
      cmdk-input-wrapper=''
    >
      <SearchIcon className='me-2 h-4 w-4 shrink-0 text-neutral-600 dark:text-neutral-400' />
      <CommandInput
    ...
    <ScrollArea className='max-h-[20rem] overflow-y-auto overflow-x-hidden [direction:inherit]'>
